            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="mobile" class="col-md-2 col-form-label text-md-end">{{ __('Mobile Number') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="pincode" class="col-md-2 col-form-label text-md-end">{{ __('Pincode') }}</label>
